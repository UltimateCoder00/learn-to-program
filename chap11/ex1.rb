# Safer picture downloading. Adapt the picture-downloading/file-
# renaming program to your computer by adding some safety features
...
if encountered_error
  puts
  puts "Press [Enter] to finish." puts
  gets
end
